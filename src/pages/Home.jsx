  ...
  return (
    <div className="bg-dark">
      ...
      <section className="about h-full lg:h-[500px]">
        <div className="container mx-auto h-full py-5 flex flex-col lg:flex-row items-center gap-12 justify-between">
          ...
          <div className="content w-[90%] lg:w-full py-4 gap-4 flex flex-col">
            <h2 className="text-[48px] text-white font-bold"><span className="text-primary">A</span>bout <span className="text-primary">U</span>s</h2>
      ...
      <section className="portfolio py-12">
        <div className="container mx-auto">
          <div className="head flex flex-col gap-3 justify-center md:flex-row items-center md:justify-between">
            <h2 className="text-[38px] text-white font-bold"><span className="text-primary">O</span>ur <span className="text-primary">P</span>ortfolio</h2>
          ...
          <div className="content grid grid-cols-1 px-6 md:px-0 md:grid-cols-3 gap-6 mt-6">
            {data.map((project) =>
              <div key={project.id} className="bg-black rounded-[28px]">
                <img src={project.img} alt={project.title} className="rounded-t-[28px]" />
      ...
      <section className="testimonials py-12">
        <div className="container mx-auto">
          <div className="head flex flex-col gap-3 justify-center md:flex-row items-center md:justify-between">
            <h2 className="text-[38px] text-white font-bold"><span className="text-primary">O</span>ur <span className="text-primary">T</span>estimonials</h2>
            <button className="btn-style">
              <Link>More Projects</Link>
            </button>
          </div>
      ...
      <section className="contact py-12">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
          <img src="./assets/ContactUs_Img.png" className="w-[90%] md:w-1/2 h-[550px]" alt="" />
          <form action="" className="w-[90%] md:w-1/2">
            <div className="flex flex-col gap-3">
              <h2 className="text-white text-5xl font-bold"><span className="text-primary">C</span>ontact <span className="text-primary">U</span>s</h2>
              <input type="text" placeholder="Name" className="input-style" />
              <input type="email" placeholder="Email" className="input-style" />
              <textarea placeholder="Message" rows={10} className="input-style" />
